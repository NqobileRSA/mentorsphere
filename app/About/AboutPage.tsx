        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((value, index) => (
              ...
              >
                <value.icon className="mb-4 h-10 w-10 text-blue-600" />
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timeline.map((event, index) => (
                ...
                >
                  {/* Year Bubble */}
                  <div className="absolute left-4 flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white lg:left-1/2 lg:-translate-x-1/2">
